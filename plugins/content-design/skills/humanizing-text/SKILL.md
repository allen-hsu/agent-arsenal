...
description: >
  ...
  Use this skill when the user wants to humanize text, says something sounds too AI, sounds like AI,
  asks to make it natural, remove AI patterns, or rewrite naturally. Based on Wikipedia's comprehensive
  "Signs of AI writing" guide. Detects and fixes 25 patterns including inflated symbolism, promotional
  language, superficial -ing analyses, vague attributions, em dash overuse, rule of three, AI vocabulary
  words, negative parallelisms, excessive conjunctive phrases, sycophantic tone, and more.
---
...
> - [checkmark] **Adoption:** Usage continues to grow, reflecting broader industry trends.
>
...
If the humanized text needs to be turned into a visual card or infographic, consider using the **creating-info-cards** skill to design a clear, shareable card from the final output.
